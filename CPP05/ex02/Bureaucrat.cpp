...
/*   Updated: 2025/02/24 22:16:37 by mac              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm &Form){
	...
	if(Form.getIsSigned() == true)
		std::cout << this->_name << " signed " << Form.getIsSigned() << std::endl;
	else
		std::cout << this->_name << " couldn't signed " << Form.getName() <<  " because " << this->getGrade() <<
		"is higher or lower than" << Form.getToSignGrade() <<std::endl;
}
...
void Bureaucrat::executeForm( const AForm &form){
	...
	{
		std::cerr << this->_name << " unable to execute " << form.getName() << " due to "<< e.what() << std::endl;
	}
